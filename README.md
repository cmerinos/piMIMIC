...
**piMIMIC** is an R package for detecting **Differential Item Functioning (DIF)** using the **Product Indicators (PI)** approach within a **MIMIC**/**RFA** framework (**Multiple Indicators Multiple Causes**/**Restricted Factor Analysis**).

The score test implementation in **piMIMIC** follows the approach illustrated in Choate (2019). The package extends these methods by incorporating effect size measures (SEPC and ΔR²).
...
Choate, A. (2019). MIMIC and DIF Testing - Psychometrics HW. <https://rpubs.com/alliechoate/502664>
